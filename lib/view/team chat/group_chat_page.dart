...
class _GroupChatScreenState extends State<GroupChatScreen> {
  ...
  File pickingImage;
  File pickingGallery;
  ReplyMessageController replyMessageController =
      Get.put(ReplyMessageController());
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
                                ...
                                GestureDetector(
                                  ...
                                  onTap: () {
                                    Get.to(PinMessagesPage(
                                      teamModel: widget.teamModel,
                                      pinMessages: snapshot.data['pinMessages'],
                                    ));
                                  },
                                ),
                                SizedBox(
              ...
              SingleChildScrollView(
                child: Container(
                  height: MediaQuery.of(context).size.height - 123.7,
                  child: Column(
                    children: <Widget>[
                      Scrollbar(
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: <
                                                                          ...
                                                                          Container(
                                                                            child:
                                                                                Text(
                                                                              snapshots.data['message'].toString().length > 20 ? '${snapshots.data['message'].toString().substring(0, 20)}...' : snapshots.data['message'],
                                                                    ...
                                                                    child: Card(
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          StreamBuilder(
                                                                            stream:
                                                                                pollController.usersWhoPolled(teamId: widget.teamModel.teamId, messageId: snapshot.data.docs[index].id),
                                                                            builder:
                                                                                (ctx, allUsersPolledSnapShot) {
                                                                              if (allUsersPolledSnapShot.hasData) {
                                                                                return StreamBuilder<QuerySnapshot>(
                                                                                  stream: FirebaseFirestore.instance.collection('personal_connections').doc('${widget.teamModel.teamId}').collection('messages').doc(snapshot.data.docs[index].id).collection('pollOptions').doc(optionSnapshot.data.docs[optionIndex].id).collection('usersPolled').snapshots(),
                                                                                  builder: (context, specificPollSnapshot) {
                                                                          ...
                                                                          ListTile(
                                                                            title:
                                                                                Text('${optionSnapshot.data.docs[optionIndex]['pollText']}'),
                                                                            subtitle:
                                                                                Text(
                                                                              '',
                                                                            ...
                                                                            trailing: IconButton(
                                                                                onPressed: () {
                                                                                  ...
                                                                                  pollController.revertPollOptions(messageId: snapshot.data.docs[index].id, teamId: widget.teamModel.teamId, pollId: optionSnapshot.data.docs[optionIndex].id, userId: getxController.user.value.userId);
                                                                                },
                                                                                icon: Icon(Icons.clear)),
                                                                            onTap:
                                                                                () {
                                                                              //send the poll of that specific user
                                                                              pollController.sendPollAnswer(messageId: snapshot.data.docs[index].id, pollOptionId: optionSnapshot.data.docs[optionIndex].id, teamId: widget.teamModel.teamId, userNameofPoller: getxController.user.value.userName, userPollingId: getxController.user.value.userId);
                                                                            },
                                                                          ),
                                                                        ],
                                                                      ),
                        ...
                        () => replyMessageController.replyToMessage.value ==
                            ...
                            ? StreamBuilder<DocumentSnapshot>(
                                stream: FirebaseFirestore.instance
                                    ...
                                    .doc('${widget.teamModel.teamId}')
                                    .collection('messages')
                                    .doc(replyMessageController.messageId.value)
                                    .snapshots(),
                                builder: (BuildContext context,
                                            ...
                                            if (_textController
                                              ...
                                              FirebaseFirestore.instance
                                                  ...
                                                  .add(
                                                {
                                                  'message':
                                                      _textController.text,
                                                  'sentBy': getxController
                                                      .authData.value,
                                                  'createdOn': FieldValue
                                                      .serverTimestamp(),
                                                  'type': replyMessageController
                                                              .replyToMessage
                                                              .value ==
                                                          true
                                                      ? 'replyMessage'
